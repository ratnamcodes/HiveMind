...
Shareable media lives in [`assets/`](assets/): five 3:2 thumbnails (the primary card features Dynatrace), the 90-second launch video, and its poster frame. The video also plays on the [live site](https://heyhivemind.com/#demo).
