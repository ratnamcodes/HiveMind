...
[<img src="assets/launch-video-poster.png" alt="Watch the 90-second launch video" width="720">](https://github.com/ratnamcodes/HiveMind/blob/main/assets/launch-video.mp4)

Click through to play the 90-second cut. More shareable media lives in [`assets/`](assets/): five 3:2 thumbnails (the primary card features Dynatrace) and the poster frame.
