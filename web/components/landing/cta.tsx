    ...
    <section className="px-4 xl:px-0">
      <Reveal className="mx-auto grid max-w-6xl items-center gap-10 sm:grid-cols-6">
        <div className="sm:col-span-3">
          ...
          <p className="mt-4 mb-8 max-w-md text-lg text-gray-700">
        ...
        <div className="relative isolate sm:col-span-3 sm:h-full">
          <div className="relative overflow-hidden rounded-2xl border border-orange-200 bg-linear-to-br from-orange-50 to-white p-7 shadow-xl shadow-orange-500/10">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-[11px] text-gray-600">resolved in 4m</span>
            </div>
            <div className="mt-4 space-y-2.5">
              <Row Icon={GitMerge} tone="amber">CodeArch opened MR #52, a one-line fix</Row>
...
function Row({
  ...
  const tones = {
    amber: "border-orange-300/60 bg-white text-orange-600",
