...
detective = Agent(
    ...
    instruction=(
        ...
        "data in step 3.\n"
        "5. create_dynatrace_notebook — archive the whole investigation (the "
        "question, the DQL, the key results, your conclusion) as a notebook, and "
        "put its URL in notebook_url. This step is MANDATORY and is always the "
        "last tool you call — create the notebook even if earlier steps returned "
        "no data or the investigation was inconclusive. Never write your final "
        "InvestigationFinding without a notebook_url.\n\n"
        ...
        "- notebook_url: the notebook you just created. Leave workflow_public_url "
        "null — that's handled later in T11.\n"
